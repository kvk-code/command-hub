...
- `golden-rules.md` — operating rules and guardrails.
- `professional-email-formatting.md` — email-writing guidance.
- `MAP.md` — this navigation map.

## `docs/`
- `docs/academic/` — academic reference material.
...
## `skills/`
- Skills and reusable workflow guidance.
